...
public class FillBlankManager2 : MonoBehaviour
{
    ...
    {
        TextAsset jsonTextAsset = Resources.Load<TextAsset>("fillBlankFood");
    ...
    public void OnCompleteLearningButtonClicked()
    {
        ...
        SceneManager.LoadScene("Selection Food");
    }
    public void OnBackClick()
    {
        SceneManager.LoadScene("Read Food");
    }
}
