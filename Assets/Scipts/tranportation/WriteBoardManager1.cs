...
public class WriteBoardManager1 : MonoBehaviour
{
    ...
    {
        TextAsset jsonTextAsset = Resources.Load<TextAsset>("write_transportation");
    ...
    {
        PlayerPrefs.SetInt("travelUnit1State", (int)UnitState.Completed);
        //if (currentUnitNumber < 4)
        //{
        //    PlayerPrefs.SetInt("lesson" + (currentUnitNumber + 1).ToString() + "State", (int)UnitState.InProgress);
        //}
        PlayerPrefs.SetInt("travelUnit2State", (int)UnitState.InProgress);
        PlayerPrefs.Save();
