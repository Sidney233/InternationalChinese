...
public class Listen_select1 : MonoBehaviour
{
    ...
    void ReadJson()
    {
        TextAsset jsonTextAsset = Resources.Load<TextAsset>("listenQuestions_transportation");
    ...
    void LoadAnswer()
    {
        ...
        curTtsPath = "http://49.52.27.216" + questions[topicIndex].tts_path.Remove(0, 1);
    ...
    {
        SceneManager.LoadScene("Listen 1");
    }
}
